...
<head>
	...
	<title>Tentang Developer - Educator</title>
	<!-- General CSS Files -->
		...
		<div class="main-wrapper">
				...
				<ul class="navbar-nav navbar-right">
					<li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<div class="dropdown-title">Admin - Educator</div>
			...
			<div class="main-content">
				<section class="section">
					<div class="">
						<div class="hero text-white hero-bg-image" data-background="https://images.unsplash.com/photo-1442544213729-6a15f1611937?q=80&w=1932&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D">
							<div class="col-md-4 mx-auto rounded-circle bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
								<img src="<?= base_url('assets/img/') ?>farhan.jpeg" class="card-img-top rounded-circle img-responsive" alt="...">
							</div>
						</div>
					</div>
					<br>
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Farhan Doli Fadhiil Siagian </h2>
								<hr>
								<p class="card-text">NIM : 201401022</p>
							</div>
						</div>
					</div>
					<br>
				...
				<section class="section">
					<div class="">
						<div class="hero text-white hero-bg-image" data-background="https://plus.unsplash.com/premium_photo-1668883189361-9c754861dbd6?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D">
							<div class="col-md-4 mx-auto rounded-circle bg-white p-3" style="border-radius:3px;box-shadow:rgba(0, 0, 0, 0.03) 0px 4px 8px 0px;">
								<img src="<?= base_url('assets/img/') ?>rizky.jpg" class="card-img-top rounded-circle img-responsive" alt="...">
							</div>
						</div>
					</div>
					<br>
					<div class="">
						<div class="card" style="width:100%;">
							<div class="card-body">
								<h2 class="card-title" style="color: black;">Muhammad Rizky Prayoga</h2>
								<hr>
								<p class="card-text">NIM : 201401024 </p>
							</div>
						</div>
					</div>
					<br>
			...
			<footer class="main-footer">
				<div class="text-center">
					Copyright &copy; 2023 Educator Team.
				</div>
			</footer>
			<!-- End Footer -->
