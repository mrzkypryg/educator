...
<head>
    ...
    <title>Data Materi - Educator</title>
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card" style="width:100%;">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Materi Educator</h2>
                            <hr>
                            <p class="card-text"> Selamat datang di halaman data materi!</p>
