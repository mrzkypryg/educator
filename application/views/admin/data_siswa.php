...
<head>
    ...
    <title>Data Siswa - Educator</title>
    <!-- General CSS Files -->
        ...
        <div class="main-wrapper">
            ...
            <div class="main-content">
                <section class="section">
                    <div class="card">
                        <div class="card-body">
                            <h2 class="card-title" style="color: black;">Management Data Siswa Educator</h2>
                            <hr>
                            <p class="card-text">Selamat datang di halaman data siswa! </p>
