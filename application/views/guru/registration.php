...
<head>
    ...
    <title>Tambah Data Guru - Educator</title>
    <!-- General CSS Files -->
...
<body>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?= base_url('admin/about_educator') ?>">Tentang
                                        Educator</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="">
                        <div class="card" style="width:100%;">
                            <div class="card-body">
                                ...
                                <hr>
                                <p class="card-text">Selamat datang di halaman tambah data guru!.
                                </p>
                            ...
                            <form method="POST" action="<?= base_url('admin/add_guru') ?>">
                                ...
                                <div class="row">
                                    <div class="form-group col-6">
                                        ...
                                        <input id="password" type="password" class="form-control pwstrength" data-indicator="pwindicator" name="password" minlength="8">
                                    ...
                                    <div class="form-group col-6">
                                        ...
                                        <input id="password2" type="password" class="form-control" name="password2" minlength="8">
    ...
    <footer class="main-footer">
        <div class="text-center">
            Copyright &copy; 2023 Education Team.
        </div>
    </footer>
    <!-- End Footer -->
