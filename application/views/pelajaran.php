...
<section class="courses_area p_40">
	<div class="container">
		<div class="main_title">
			<h2 data-aos="fade-up" data-aos-duration="1600">Pelajaran Yang Tersedia di Educator</h2>
			<p data-aos="fade-up" data-aos-duration="1800">Berikut beberapa materi pembelajaran yang kami sediakan untuk mendukung peningkatan kualitas tenaga pendidik di Indonesia.</p>
		</div>
					...
					<div class="grid_item wd55">
						<div class="courses_item" data-aos="fade-right" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									<li><a href="#"><i class="lnr lnr-user"></i>Educator Team</a>
									</li>
								</ul>
							</div>
						</div>
					...
					<div class="grid_item wd44">
						<div class="courses_item" data-aos="fade-down" data-aos-duration="1800">
							...
							<div class="hover_text">
								...
								<ul class="list">
									<li><a href="#"><i class="lnr lnr-user"></i>Educator Team</a></li>
								</ul>
							</div>
						</div>
					</div>
