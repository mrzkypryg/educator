    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li><a href="<?= base_url('welcome/tentang') ?>">Tentang Educator</a></li>
                        <li><a href="<?= base_url('welcome/pelajaran') ?>">Materi Educator</a></li>
                        <li><a href="<?= base_url('welcome/kontak') ?>">Kontak Educator</a></li>
                        <li><a href="https://fasilkom-ti.usu.ac.id/en/">Website Resmi Fakultas</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
            ...
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        ...
                        <li><a href="javaScript:void(0);">Soft Skill</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-2  col-md-6 col-sm-6">
                <div class="single-footer-widget tp_widgets">
                    ...
                    <ul class="list">
                        <li>Website ini dirancang oleh dua Mahasiswa Program Studi S-1 Ilmu Komputer Universitas Sumatera Utara yaitu Farhan Doli Fadhiil Siagian (201401022) dan Muhammad Rizky Prayoga (201401024) </li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6">
                <h4 class="footer_title">Tentang Educator</h4>
                <p>
                Educator adalah Web Edukasi yang dirancang untuk mendukung kemajuan pendidikan Indonesia menjadi lebih baik terutama kepada tenaga pendidik.
        ...
        <div class="row footer-bottom d-flex justify-content-between align-items-center">
            <p class="col-lg-8 col-md-8 footer-text m-0">
                ...
                </script> Educator Team. All rights reserved | This template is made with <span class="text-danger"> &#10084;</span> by
                <a href="https://colorlib.com" target="_blank">Colorlib</a>
                <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            <div class="col-lg-4 col-md-4 footer-social">
                <a href="https://www.github.com/mrzkypryg"><i class="fa fa-github"></i></a>
                <a href="https://www.youtube.com/channel/UC2qlMnA8tubv0a9y6X8-qjA/featured"><i class="fa fa-youtube"></i></a>
            </div>
        </div>
    </div>
</footer>
                            ...
                            <form action="<?= base_url('welcome/validateLogin') ?>" method="post">
                                <div class="form-group">
                                    <label class="label-font" for="
                                        ...
                                        Email</label>
                                    <input type="email" value="<?= set_value('email'); ?>" class="form-control" name="email" autocomplete="off" id="email" placeholder="Masukan email mu disini .." required>
                                ...
                                <div class="form-group">
                                    <label class="label-font" for="
                                        exampleFormControlInput1">
                                        Password</label>
                                    <input type="password" name="password" class="form-control" id="password" placeholder="Masukan password mu disini .." minlength="8" required>
                                    <small class="text-danger"></small>
                                </div>
                                ...
                                <button class="btn btn-block font-weight-bold" style="background-color: #4E74F9;color:white;font-size:18px;">Login
                                    Sekarang!</button>
                            </form>
                        </div>
                    </div>
...
<?php if ($this->session->flashdata('false-login')) : ?>
    <script>
        ...
        Swal.fire({
            ...
            text: 'Silahkan Periksa Kembali Email atau Password Kamu!',
            showConfirmButton: false,
            timer: 2500
        });
    </script>
