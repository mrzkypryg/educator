...
<head>
    ...
    <meta content="Educator sebagai platform yang dihadirkan sebagai wadah peningkatan soft skill dan hard skill tenaga pengajar di Indonesia" name="Description" />
    <link rel="icon" href="<?= base_url('assets/') ?>img/favicon.png" type="image/png">
    <title>Educator - Tingkatkan Soft Skill dan Hard Skillmu Sekarang !</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?= base_url('welcome') ?>"><img style="height:35px"; src="<?= base_url('assets/') ?>img/logo.png" alt=""></a>
