        ...
        <div class="main_menu">
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href="<?= base_url('user') ?>"><img style="height:35px" style="height:35px"; src="<?= base_url('assets/') ?>img/logo.png" alt=""></a>
            ...
            <div class="row" style="color: black; font-family: 'poppins';">
                <div class="col-md-12 mt-1">
                    <h1 class="display-4" style="color: black; font-family:'poppins';" data-aos="fade-down" data-aos-duration="1400">Selamat Datang
                        di Educator <span style="font-size: 40px;">👋🏻
                        </span> </h1>
                    <p>Hello Students! , Ini merupakan halaman utama Educator ! Silahkan pilih kelas yang akan kamu
                        akses
            ...
            <div class="col-md-12">
                <div class="row">
                    <div class="col-sm-4 mb-2 d-flex justify-content-center " data-aos-duration="1900" data-aos="fade-right">
                        <a href="<?= base_url('user/tingkatsd') ?>">
                            <div class="card-kelas text-center">
                                <img src="<?= base_url('assets/') ?>img/tp_sd.jpg" style="object-fit: cover;" class="card-img-top img-fluid" alt="...">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 mb-2 d-flex justify-content-center " data-aos-duration="1900" data-aos="fade-down">
                        <a href="<?= base_url('user/tingkatsmp') ?>">
                            <div class="card-kelas">
                                <img src="<?= base_url('assets/') ?>img/tp_smp.jpg" class="card-img-top" alt="...">
                            </div>
                        </a>
                    </div>
                    <div class="col-sm-4 mb-2 d-flex justify-content-center" data-aos-duration="1900" data-aos="fade-left">
                        <a href="<?= base_url('user/tingkatsma') ?>">
                            <div class="card-kelas">
                                <img src="<?= base_url('assets/') ?>img/tp_sma.jpg" class="card-img-top" alt="...">
                            </div>
                        </a>
                    </div>
                </div>
